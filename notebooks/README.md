...
* `genie_analysis.ipynb`: A demonstrative analysis notebook that highlights how patient fusions from the AACR Project GENIE cohort can be matched
to the CIViC and Molecular Oncology Almanac knowledgebases to return clinical evidence and assertion statements.
